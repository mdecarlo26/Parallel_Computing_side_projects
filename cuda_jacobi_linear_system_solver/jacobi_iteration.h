...
/* Function prototypes */
extern "C" void compute_gold(const matrix_t, matrix_t, const matrix_t,int);
...
void compute_on_device(const matrix_t, matrix_t, matrix_t, const matrix_t,int,int);
...
void free_ssd_on_device(double*);
matrix_t makeTranspose(matrix_t);
